...
function setDias() 
{
	forms.cli_turnos_calendario_old['vl_dia_29'] = ''
	forms.cli_turnos_calendario_old['vl_dia_30'] = ''
	forms.cli_turnos_calendario_old['vl_dia_31'] = ''		
	var fecha = new Date()
	var dias = 31
	...
	for(var i=1; i<=dias;i++)
	{
		...
		{
		case 0:
		forms.cli_turnos_calendario_old[lbl] = i + '-Do'
		//elements[lbl].bgcolor = '#9a9a9a'
		break;			
		case 1:
		forms.cli_turnos_calendario_old[lbl] = i + '-Lu'
		//elements[lbl].bgcolor = '#666666'			
			break;
		case 2:
		forms.cli_turnos_calendario_old[lbl] = i + '-Ma'
		//elements[lbl].bgcolor = '#666666'			
		break;
		case 3:
		forms.cli_turnos_calendario_old[lbl] = i + '-Mi'
		//elements[lbl].bgcolor = '#666666'			
		break;
		case 4:
		forms.cli_turnos_calendario_old[lbl] = i + '-Ju'
		//elements[lbl].bgcolor = '#666666'			
		break;
		case 5:
		forms.cli_turnos_calendario_old[lbl] = i + '-Vi'
		//elements[lbl].bgcolor = '#666666'			
		break;
		case 6:
		forms.cli_turnos_calendario_old[lbl] = i + '-Sa'
		//elements[lbl].bgcolor = '#666666'			
		break;
		}
	}
